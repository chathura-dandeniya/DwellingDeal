...
const storeItems = new Map([
    [1, { priceInCents: 10000, name: "Product Titlr A" }],
    [2, { priceInCents: 4000, name: "Product Title B" }],
]);
        ...
        return new Promise(async (resolve, reject) => {
            try {
                ...
                const session = await stripe.checkout.sessions.create({
                    ...
                    success_url: `${secretConfig.CLIENT_URL}/success`,  // URL where users will be redirected upon successful payment
                    cancel_url: `${secretConfig.CLIENT_URL}/cancel`,    // URL where users will be redirected upon cancellation
                });
